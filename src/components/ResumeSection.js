    ...
    <section id="resume" className="py-20 px-6 bg-cosmic-darker">
      <div className="container mx-auto max-w-4xl">
        <div className="terminal-border rounded-lg p-8 text-center">
          ...
          {/* Summary as code comments */}
          <div className="text-left max-w-md mx-auto mb-8">
            <div className="space-y-2 text-gray-400 font-mono text-sm">
              <p>// DevOps-focused CS student</p>
              <p>// Strong open-source contributor</p>
              <p>// Built and deployed automation pipelines</p>
            </div>
          </div>
          
          <button className="group relative inline-flex items-center justify-center px-8 py-3 text-lg font-mono font-semibold text-cosmic-dark bg-terminal-green rounded-lg transition-all duration-300 hover:bg-terminal-amber hover:shadow-lg hover:shadow-terminal-green/50 hover:scale-105">
